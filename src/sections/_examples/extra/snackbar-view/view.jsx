    ...
    <>
      ...
      >
        <ComponentBlock title="Simple">
          ...
          <Button variant="contained" color="success" onClick={() => toast.success('This is an success')}>
            Success
          </Button>
          <Button variant="contained" color="warning" onClick={() => toast.warning('This is an warning')}>
            Warning
          </Button>
        ...
        <ComponentBlock title="anchorOrigin">
          {['top-left', 'top-center', 'top-right', 'bottom-left', 'bottom-center', 'bottom-right'].map((position) => (
            <Button key={position} variant="text" color="inherit" onClick={() => toast(position, { position })}>
              {position}
            </Button>
          ))}
        </ComponentBlock>
